...
require('lazy').setup({
  ...
  require 'hitblast.plugins.debug',
  require 'hitblast.plugins.indent-blankline',
  require 'hitblast.plugins.lint',
  require 'hitblast.plugins.autopairs',
  require 'hitblast.plugins.neo-tree',
  require 'hitblast.plugins.gitsigns',
}, {
  ui = {
